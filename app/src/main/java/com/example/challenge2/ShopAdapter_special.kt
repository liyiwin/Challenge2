...
class ShopAdapter_special(val context: Context, private val layoutManager: GridLayoutManager? = null, var outerList: MutableList<Model> ): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    companion object {
        ...
        open val DETAILED  = 2
         ...
         var thisBuy :buyItem_Three? = null


        interface buyItem_Three
