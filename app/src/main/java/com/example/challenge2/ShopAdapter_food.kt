...
class ShopAdapter_food(val context: Context, private val layoutManager: GridLayoutManager? = null, var outerList: MutableList<Model> ):RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    companion object {
       ...
       var thisBuy :buyItem_One? = null


        interface buyItem_One
